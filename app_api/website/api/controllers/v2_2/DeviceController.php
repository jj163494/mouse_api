...
class DeviceController extends PublicController{
    ...
    /**
     * @SWG\Post(
     *     path="/app_api/website/api.php/v2_2/device/bindDevice",
     *     summary="21.绑定设备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Delete(
     *     path="/app_api/website/api.php/v2_2/device/removeDevice",
     *     summary="22.解除设备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_2/device/getUserDeviceList",
     *     summary="23.获取已绑定的设备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_2/device/getDeviceInfo",
     *     summary="26.取得设备信息",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Post(
     *     path="/app_api/website/api.php/v2_2/device/updateDeviceName",
     *     summary="88.修改设备名称",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Post(
     *     path="/app_api/website/api.php/v2_2/device/saveUserEquipment",
     *     summary="82.保存装备数据",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_2/device/getUserEquipmentList",
     *     summary="83.查看用户所有装备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_2/device/getUserEquipmentInfo",
     *     summary="84.获取用户装备详情",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Delete(
     *     path="/app_api/website/api.php/v2_2/device/removeUserEquipment",
     *     summary="85.删除用户装备数据",
     *     tags={"Device"},
