...
class UserController extends PublicController{
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_2/user/login",
     *     summary="1.用户登录",
     *     tags={"User"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_2/user/getUserTerminalList",
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_2/user/quickLogin",
     *     summary="108.快捷登录",
     *     tags={"User"},
