...
class MacroController extends PublicController {
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v3_1/macro/uploadMacro",
	 *     summary="34.上传宏",
	 *     tags={"Macro"},
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v3_1/macro/getMacroInfo",
	 *     summary="35.获取宏信息",
	 *     tags={"Macro"},
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v3_1/macro/getMacroList",
	 *     summary="46.获取用户宏列表",
	 *     tags={"Macro"},
	...
	/**
	 * @SWG\Delete(
	 *     path="/app_api/website/api.php/v3_1/macro/deleteMacro",
	 *     summary="45.删除宏",
	 *     tags={"Macro"},
	 *     description="上传用户配置的宏",
	 *     operationId="",
