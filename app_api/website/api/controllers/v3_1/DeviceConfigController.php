...
class DeviceConfigController extends PublicController{
    ...
    /**
     * @SWG\Post(
     *     path="/app_api/website/api.php/v3_1/deviceConfig/uploadDeviceConfig",
     *     summary="109.上传设备配置",
     *     tags={"DeviceConfig"},
    ...
    /**
     * @SWG\Delete(
     *     path="/app_api/website/api.php/v3_1/deviceConfig/deleteDeviceConfig",
     *     summary="110.删除设备配置",
     *     tags={"DeviceConfig"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v3_1/deviceConfig/getDeviceConfigInfo",
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v3_1/deviceConfig/getDeviceConfigList",
