...
class ComputerController extends PublicController{
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v3_1/computer/addComputer",
	 *     summary="94.添加主机信息",
	 *     tags={"Computer"},
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v3_1/computer/uploadComputerConfig",
	 *     summary="95.上传主机设置",
	 *     tags={"Computer"},
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v3_1/computer/downloadComputerConfig",
	 *     summary="96.下载主机设置",
	 *     tags={"Computer"},
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v3_1/computer/saveComputerHistory",
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v3_1/computer/GetComputerSummary",
	...
	/**
	 * @SWG\Delete(
	 *     path="/app_api/website/api.php/v3_1/computer/clearComputerHistory",
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v3_1/computer/addGameHistory",
	 *     summary="104.新增游戏记录",
	 *     tags={"Computer"},
	...
	/**
	 * @SWG\Delete(
	 *     path="/app_api/website/api.php/v3_1/computer/clearGameHistory",
	 *     summary="105.清除游戏记录",
	 *     tags={"Computer"},
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v3_1/computer/getGameHistoryList",
