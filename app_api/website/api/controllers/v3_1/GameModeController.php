...
class GameModeController extends PublicController{
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v3_1/gameMode/addGameMode",
	 *     summary="97.增加游戏模式",
	 *     tags={"GameMode"},
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v3_1/gameMode/updateGameMode",
	 *     summary="98.修改主机游戏模式",
	 *     tags={"GameMode"},
	...
	/**
	 * @SWG\Delete(
	 *     path="/app_api/website/api.php/v3_1/gameMode/removeGameMode",
	 *     summary="99.删除主机游戏模式",
	 *     tags={"GameMode"},
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v3_1/gameMode/getGameModeList",
