...
class UserController extends PublicController{
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_1/user/login",
     *     summary="1.用户登录",
     *     tags={"User"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_1/user/getUserTerminalList",
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_1/user/quickLogin",
     *     summary="108.快捷登录",
     *     tags={"User"},
