...
class DeviceController extends PublicController{
    ...
    /**
     * @SWG\Post(
     *     path="/app_api/website/api.php/v2_1/device/bindDevice",
     *     summary="21.绑定设备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Delete(
     *     path="/app_api/website/api.php/v2_1/device/removeDevice",
     *     summary="22.解除设备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_1/device/getUserDeviceList",
     *     summary="23.获取已绑定的设备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_1/device/getDeviceInfo",
     *     summary="26.取得设备信息",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Post(
     *     path="/app_api/website/api.php/v2_1/device/updateDeviceName",
     *     summary="88.修改设备名称",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Post(
     *     path="/app_api/website/api.php/v2_1/device/saveUserEquipment",
     *     summary="82.保存装备数据",
     *     tags={"Device"},
    ...
    public function actionSaveUserEquipment() {
        ...
        if (! empty ( $equipment_info )) {
            ...
            $equipment_model->device_name = $device_model;                      // 设备名称
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_1/device/getUserEquipmentList",
     *     summary="83.查看用户所有装备",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Get(
     *     path="/app_api/website/api.php/v2_1/device/getUserEquipmentInfo",
     *     summary="84.获取用户装备详情",
     *     tags={"Device"},
    ...
    /**
     * @SWG\Delete(
     *     path="/app_api/website/api.php/v2_1/device/removeUserEquipment",
     *     summary="85.删除用户装备数据",
     *     tags={"Device"},
