...
class UploadController extends PublicController {
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v2_1/upload/getTrainingInfoByDate",
	...
	/**
	 * @SWG\Post(
	 *     path="/app_api/website/api.php/v2_1/upload/getTrainingResult",
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v2_1/upload/getTrainingSummary",
	...
	/**
	 * @SWG\Get(
	 *     path="/app_api/website/api.php/v2_1/upload/getTrainingList",
