...
/**
 * This is the model class for table "td_keycap_light_set".
 *
 * The followings are the available columns in table 'td_keycap_light_set':
 * @property integer $id
 ...
 */
class TdKeycapLightSet extends CActiveRecord
{
	/**
	 ...
	 * @return TdKeycapLightSet the static model class
	 */
